...
<head>
    ...
    <?php // SiteNavigationElement Schema - uses vanity domain for SEO consistency ?>
        ...
        "@graph": [
            {
                ...
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/#features'); ?>",
                "name": "Features",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/#features'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/examples/'); ?>",
                "name": "Examples",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/examples/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/pro/'); ?>",
                "name": "Pro",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/pro/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/documentation/'); ?>",
                "name": "Documentation",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/documentation/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/changelog/'); ?>",
                "name": "Changelog",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/changelog/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/wordpress-pdf-viewer/'); ?>",
                "name": "WordPress PDF Viewer",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/wordpress-pdf-viewer/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/drupal-pdf-viewer/'); ?>",
                "name": "Drupal PDF Viewer",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/drupal-pdf-viewer/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/nextjs-pdf-viewer/'); ?>",
                "name": "React / Next.js PDF Viewer",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/nextjs-pdf-viewer/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/compare/'); ?>",
                "name": "Plugin Comparison",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/compare/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/enterprise/'); ?>",
                "name": "Enterprise",
                "url": "<?php echo esc_url(PDFVIEWER_VANITY_DOMAIN . '/enterprise/'); ?>"
            },
            {
                "@type": "SiteNavigationElement",
                "@id": "https://dross.net/contact/?topic=pdfviewer",
                "name": "Contact",
                "url": "https://dross.net/contact/?topic=pdfviewer"
            }
        ]
    }
    </script>
