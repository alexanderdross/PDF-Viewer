        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="p-6 rounded-2xl bg-card border border-border">
                    ...
                    <p class="text-sm text-muted-foreground leading-relaxed"><?php esc_html_e('The General Data Protection Regulation (GDPR) is a European Union regulation that protects the personal data and privacy of individuals in the EU/EEA. It requires organizations to minimize data collection, provide transparency, and give individuals control over their data. Our React components support GDPR with IP anonymization, no third-party data transfers, consent management, and audit logging.', 'pdfviewer'); ?></p>
                </div>
                <div class="p-6 rounded-2xl bg-card border border-border">
                    <div class="flex items-center gap-3 mb-3">
                    ...
                    <p class="text-sm text-muted-foreground leading-relaxed"><?php esc_html_e('The Health Insurance Portability and Accountability Act (HIPAA) is a US federal law that protects sensitive patient health information (PHI). It requires access controls, audit trails, data integrity, and transmission security. Our React components support HIPAA with role-based access control, two-factor authentication, complete audit logs, and secure document delivery.', 'pdfviewer'); ?></p>
                </div>
            </div>
